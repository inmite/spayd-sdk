...
public class SpaydReaderTest {
	...
	static final String validCode1 = "SPD*1.0*ACC:CZ5855000000001265098001*AM:480.50*CC:CZK*RF:1234567890123456*DT:20120524*MSG:PLATBA ZA ZBOZI";
	static final String validCode2 = "SPD*1.0*ACC:CZ5855000000001265098001+RZBCCZPP*AM:480.50*CC:CZK*RF:1234567890123456*DT:20120524*MSG:PLATBA ZA ZBOZI";
	static final String validCode3 = "SPD*1.0*ACC:CZ5855000000001265098001+RZBCCZPP*AM:480.50*CC:CZK*" +
			"RF:1234567890123456*DT:20120524*MSG:PLATBA ZA ZBOZI*PT:STD*" +
			"NT:P*NTA:608328707*RN:Tomas";

	static final String invalidCode1 = "SSS*1.0*ACC:CZ5855000000001265098001+RZBCCZPP*AM:480.50*CC:CZK*RF:1234567890123456*DT:20120524*MSG:PLATBA ZA ZBOZI";
